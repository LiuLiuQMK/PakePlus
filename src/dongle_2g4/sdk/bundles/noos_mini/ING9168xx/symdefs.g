att_dispatch_client_can_send_now = 0x02005089;
att_dispatch_client_request_can_send_now_event = 0x0200508f;
att_dispatch_register_client = 0x02005095;
att_dispatch_register_server = 0x020050a9;
att_dispatch_server_can_send_now = 0x020050bd;
att_dispatch_server_request_can_send_now_event = 0x020050c3;
att_emit_general_event = 0x02005175;
att_server_can_send_packet_now = 0x020058a9;
att_server_deferred_read_response = 0x020058ad;
att_server_get_mtu = 0x020058c5;
att_server_indicate = 0x02005931;
att_server_init = 0x020059b5;
att_server_notify = 0x020059f1;
att_server_register_packet_handler = 0x02005b09;
att_server_request_can_send_now_event = 0x02005b3b;
